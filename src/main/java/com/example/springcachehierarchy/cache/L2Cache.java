...
public class L2Cache extends ConcurrentMapCache {
	...
	public L2Cache(final String name) {
		super(name);
	}

	public L2Cache(final String name, final boolean allowNullValues) {
		super(name, allowNullValues);
	}

	public L2Cache(final String name, final ConcurrentMap<Object, Object> store, final boolean allowNullValues) {
		super(name, store, allowNullValues);
	}

	protected L2Cache(final String name, final ConcurrentMap<Object, Object> store, final boolean allowNullValues,
